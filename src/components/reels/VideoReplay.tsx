...
const VideoReplay = () => {
     ...
     const getStreams = async ()=>{
          try{
               let data = await supabase.from('stream_info').select().eq('status','live');
               ...
               <div className="flex justify-between gap-5 h-[75vh]">
                    <div className="relative w-[50%] h-full overflow-hidden rounded-lg">
                         ...
                         <div className="absolute bottom-5 w-[75%] left-5 flex flex-col gap-2">
                              <p className="text-[1.5rem] font-[600] text-[#bc2449]">Aura vì khách hàng</p>
                    ...
                    <div className="flex flex-col gap-5 relative w-[50%] h-full">
                    {
                         streams?.length == 1?
                              <>
                                   <div className="h-[50%]">
                                        ...
                                        <div className="px-5">
                                             <p className="font-[700] my-1 text-[1.1rem] text-[#bc2449]">Thẩm mỹ viện quốc tế Aura</p>
                                             <div className="flex justify-between">
                                                  <span>{streams[0]?.name}</span>
                                                  <p>5/7/2023     10:30</p>
                                             </div>
                                        </div>
                                   </div>
                         ...
                         <>
                              ...
                              <div className="relative rounded-lg h-[80%] overflow-hidden">
                                   ...
                                   <div className="px-5">
                                        <p className="font-[700] my-1 text-[1.1rem] text-[#bc2449]">Combo mày môi tùy chọn</p>
                                        <div className="flex justify-between">
                                             <span>@Heo</span>
                                             <p>5/5/2023     7:30</p>
                                        </div>

     ...
     return (  
          <div className="w-full h-auto px-[5rem] pt-5 flex-wrap">
               <div className="flex justify-between items-center">
                    ...
                    <Link href="/live-commerce" className="flex items-center gap-5"> <span className="font-[700] py-5 text-[2rem] text-[#bc2449]">Xem thêm</span><BsChevronRight className="text-[2rem] text-[#bc2449]"/> </Link>
               </div>

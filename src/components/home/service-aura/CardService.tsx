  ...
  return (
    <div className="lg:flex-shrink-0 lg relative lg:rounded-[40px] ">
      ...
      <div className="flex flex-col lg:pr-[20px] justify-end pb-[30px] w-full lg:h-[500px] absolute z-[100] lg:bottom-0 ">
        <div className="font-service-card w-full lg:h-[115px] linear-yellow-text lg:text-right z-[100] -rotate-[10deg] lg:text-[62px]">
          {name}
        </div>
        <div className="linear-yellow-text  lg:-rotate-[10deg] lg:text-right lg:text-[20px] text-[12px] font-[700] lg:leading-[28px] lg:tracking-[-0.25px]">
          {tagline}
        </div>
      </div>
    </div>

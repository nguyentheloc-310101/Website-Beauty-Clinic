...
export const CardCustomer = (props: CardCustomerProps) => {
  ...
  return (
    <div className="card-customer">
      <div className="flex md:relative md:ml-[25px] flex-col w-[286px] h-full items-center lg:justify-center lg:ml-[56px]">
        ...
        <span className="hidden text-[#B24B64B3] font-[400] lg:text-[50px] lg:tracking-[-0.18px]">
          {signed}
        </span>
      </div>
      <div>
        <Image
          src={image}
          alt={'image-customer'}
          className="w-auto h-[273px] left-[55px] top-[-90px] md:right-[20px] lg:top-0 lg:bottom-[10px] lg:h-[400px] absolute lg:relative"
        />
      </div>
    </div>
  );

...
const HeaderAura = ({isMobile}:Props) => {
  ...
  return (
    ...
    <div className="relative flex justify-between items-center py-[1rem] px-[20px]">
      ...
      />
      <div></div>
      <div className={`z-[100] absolute p-5 top-[5rem] left-0 bg-white flex flex-col w-[60vw] gap-3 transition-transform duration-500 ${
          ...
          <Link href="/">
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
                ...
                />
                <span className="font-[700] text-[1rem] text-[#bc2449]">Trang chủ</span>
              </div>
          ...
          <div className="flex justify-between items-center">
            <div className="flex gap-2 items-center">
              <Image
                ...
                className="w-[1rem] h-[1rem]"
              />
              <span className="font-[700] text-[1rem] text-[#bc2449]">Dịch vụ</span>
            </div>
            <BsChevronDown className="text-[1rem] text-[rgba(0,0,0,0.2)]"/>
          </div>
          <div className="flex flex-col pl-[2rem] ga[-2">
            ...
            <div className="flex justify-between items-center py-2">
              <span className="font-[700] text-[1rem]">Tạo hình không xâm lấn</span>
              <BsChevronDown className="text-[1rem] text-[rgba(0,0,0,0.2)]"/>
            </div>
          </div>
          <Image
    ...
    <div className="w-full h-[100px] flex xl:px-[10rem] lg:px-[7rem]  md:px-[6rem] py-[1rem] items-center">
      ...
      <div className="flex ml-[10%] w-full font-[600] text-[#bc2449] text-[16px] items-center justify-between">
        ...
        <span className="text-center">GIỚI THIỆU</span>
        <span className="text-center">ƯU ĐÃI</span>
        <span className="text-center">LIÊN HỆ</span>
        <div className="flex flex-col items-center">
          <span className="text-[16px] font-[500px] text-center">Tư vấn miễn phí</span>
          <span className="font-[700px] text-[18px] text-black text-center">
            0833.08.2222
          </span>
        </div>
      </div>
